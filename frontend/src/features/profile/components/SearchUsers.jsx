...
function SearchUsers({ setSearchUsers }) {
    ...
    return (
        <div onClick={(e) => handleClick(e)} className="h-screen w-screen">
            <div ref={containerRef} className="h-[80%] w-[50%] min-w-80 flex flex-col rounded-xl bg-[#202023] absolute justify-self-center top-1/2 -translate-y-1/2 p-4 shadow-[0px_0px_16px_black]">
