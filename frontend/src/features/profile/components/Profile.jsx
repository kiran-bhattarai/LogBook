    ...
    return (
        <div className="h-full bg-white/30 dark:bg-black/30">
            <div className="p-4 flex  items-center justify-center">
                <img src={avatar ? avatar : DefaultAvatar} referrerPolicy="no-referrer" alt="avatar" height={80} width={80} className="h-20 rounded-full bg-neutral-300 border-2 border-black dark:border-white mr-4" />
                <div className="">
