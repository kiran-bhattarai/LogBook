...
function Dashboard() {
    ...
    return (
            <div className="bg-neutral-900 flex-1 text-white text-xl overflow-hidden">

                <div className="items-center justify-center flex-col flex pb-12 px-4 bg-neutral-950 border-b border-neutral-600">
                    <h1 className="text-6xl font-medium my-2">Users</h1>
                    <div>
                        ...
                        <div className="flex items-center justify-center flex-wrap gap-10">
                            ...
                            <div className="justify-center items-center flex flex-col w-min gap-5">
                                <LineChart width={500} height={300} data={prepareChartData(dashboardData.usersPerDayFormatted, "New users", 7)}>
                ...
                <div className="items-center justify-center flex-col flex pb-12 px-4 bg-neutral-950">
                    <h1 className="text-6xl font-medium my-2">Notes</h1>
                    ...
                    <div>
                        ...
                        <div className="flex items-center justify-center flex-wrap gap-10">
                            ...
                            <div className="justify-center items-center flex flex-col w-min gap-5">
                                <LineChart width={500} height={300} data={prepareChartData(dashboardData.notesPerDayFormatted, "New notes", 7)}>
                                    <CartesianGrid strokeDasharray="3 3" />
                                    <XAxis dataKey="date" />
                                    <YAxis />
                                    <Tooltip />
