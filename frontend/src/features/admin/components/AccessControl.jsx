...
function AccessControl() {
  ...
  return (
        <div className="justify-self-center w-full h-full items-center flex flex-col justify-center font-inter px-2">
          <div className="max-w-210 w-full bg-black/30">

            <div className=" w-full flex sm:flex-row flex-col items-center px-1 border border-neutral-700 rounded-[13px_13px_0px_0px]">
              ...
              <select name="" id="sort" className="text-white text-md outline-none cursor-pointer m-2 sm:m-0" onChange={(e) => setSortId(parseInt(e.target.value))}>
                <option value="1" className="bg-black">Newest first</option>
                <option value="2" className="bg-black">Oldest first</option>
                <option value="3" className="bg-black">Alphabetical</option>
                <option value="4" className="bg-black">Alphabetical reverse</option>
                <option value="5" className="bg-black">Most Notes</option>
                <option value="6" className="bg-black">Least Notes</option>
              </select>
