...
function NoteInput() {
    ...
    return (
            ...
            <div className="bg-neutral-700 flex-1 items-center inline">
                <div ref={containerRef} className="flex flex-col w-[40%]  bg-neutral-800 items-center justify-self-center m-4 p-1 border border-neutral-400 rounded" onBlur={handleBlur}>
